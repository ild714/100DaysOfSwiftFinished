...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        let displayLink = CADisplayLink(target: self, selector: #selector(update1))
    ...
    @objc func createEnemy() {
        ...
        if sum % 20 == 0 {
            ...
            self.gameTimer = Timer.scheduledTimer(timeInterval: time - 0.1, target: self, selector: #selector(createEnemy), userInfo: nil, repeats: true)
        }
    }
